...
void trigger()
{
    ...
    microDelay(10);	// 10us Trigger signal
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  while(1)
	  {
		  int e1 = HAL_GPIO_ReadPin(Echo_Port, Echo_Pin);
		  if(e1 == 1) break;
	  }
	  */
	  ...
	  printf("\033[10;25f\033#3Distance : %.2f cm   ", d);
	  printf("\033[11;25f\033#4Distance : %.2f cm   \033[9;10H\n", d);
